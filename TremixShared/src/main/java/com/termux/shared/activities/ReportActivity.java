package com.tremix.shared.activities;
 ...
 * {@code `<activity android:name="com.tremix.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TremixReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.tremix.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
    ...
    private void updateUI() {
        ...
        if (actionBar != null) {
            if (mReportInfo.reportTitle != null)
                ...
                actionBar.setTitle(TremixConstants.TERMUX_APP_NAME + " App Report");
        }
