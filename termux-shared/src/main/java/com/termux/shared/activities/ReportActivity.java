package com.termix.shared.activities;
 ...
 * {@code `<activity android:name="com.termix.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TremixReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.termix.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
