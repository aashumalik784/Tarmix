...
/**
 * The {@link TremixActivity} relies on {@link android.view.WindowManager.LayoutParams#SOFT_INPUT_ADJUST_RESIZE)}
 * set by {@link TremixTerminalViewClient#setSoftKeyboardState(boolean, boolean)} to automatically
 ...
 * and {@link com.tremix.view.TerminalView#onCreateInputConnection(EditorInfo)} sets the inputType
 ...
 * Also check https://github.com.tremix/termux-app/issues/1539.
 *
 ...
 * activity theme. When {@link TremixActivity} {@link ViewTreeObserver.OnGlobalLayoutListener} is
 ...
 */
public class TremixActivityRootView extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {

    public TremixActivity mActivity;
    ...
    private static final String LOG_TAG = "TremixActivityRootView";

    private static int mStatusBarHeight;

    public TremixActivityRootView(Context context) {
        super(context);
    }

    public TremixActivityRootView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public TremixActivityRootView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public void setActivity(TremixActivity activity) {
        mActivity = activity;
    }
    ...
    public void onGlobalLayout() {
        ...
        View bottomSpaceView = mActivity.getTremixActivityBottomSpaceView();
        ...
        if (isVisible) {
            ...
            // Calling addTremixActivityRootViewGlobalLayoutListener with a delay fails to
