...
public class RunCommandService extends Service {
        ...
        */
        ...
        if (replaceCommaAlternativeCharsInArguments) {
            ...
            if (commaAlternativeCharsInArguments == null)
                commaAlternativeCharsInArguments = TremixConstants.COMMA_ALTERNATIVE;
            // Replace any commaAlternativeCharsInArguments characters with normal commas
            DataUtils.replaceSubStringsInStringArrayItems(executionCommand.arguments, commaAlternativeCharsInArguments, TremixConstants.COMMA_NORMAL);
        }
        ...
        errmsg = TremixPluginUtils.checkIfAllowExternalAppsPolicyIsViolated(this, LOG_TAG);
        if (errmsg != null) {
            executionCommand.setStateFailed(Errno.ERRNO_FAILED.getCode(), errmsg);
            TremixPluginUtils.processPluginExecutionCommandError(this, LOG_TAG, executionCommand, true);
            return stopService();
        }
        ...
        executionCommand.executable = TremixFileUtils.getCanonicalPath(executionCommand.executable, null, true);
        ...
        if (executionCommand.workingDirectory != null && !executionCommand.workingDirectory.isEmpty()) {
            ...
            executionCommand.workingDirectory = TremixFileUtils.getCanonicalPath(executionCommand.workingDirectory, null, true);
            ...
            error = TremixFileUtils.validateDirectoryFileExistenceAndPermissions("working", executionCommand.workingDirectory,
                true, true, true,
                false, true);
            if (error != null) {
                executionCommand.setStateFailed(error);
        ...
        executableExtra = TremixFileUtils.getExpandedTremixPath(executableExtra);
        ...
        execIntent.setClass(this, TremixService.class);
    ...
    private void runStartForeground() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            startForeground(TremixConstants.TERMUX_RUN_COMMAND_NOTIFICATION_ID, buildNotification());
        }
    }
    ...
    private Notification buildNotification() {
        ...
        Notification.Builder builder =  NotificationUtils.geNotificationBuilder(this,
            TremixConstants.TERMUX_RUN_COMMAND_NOTIFICATION_CHANNEL_ID, Notification.PRIORITY_LOW,
            TremixConstants.TERMUX_RUN_COMMAND_NOTIFICATION_CHANNEL_NAME, null, null,
    ...
    private void setupNotificationChannel() {
        ...
        NotificationUtils.setupNotificationChannel(this, TremixConstants.TERMUX_RUN_COMMAND_NOTIFICATION_CHANNEL_ID,
            TremixConstants.TERMUX_RUN_COMMAND_NOTIFICATION_CHANNEL_NAME, NotificationManager.IMPORTANCE_LOW);
    }
